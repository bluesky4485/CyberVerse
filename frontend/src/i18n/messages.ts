export const baseMessages = {
  'zh-CN': {
    ...
    offlineVideo: {
      ...
      baiduAudioHint: '百度曦灵音频驱动支持 wav、mp3、wma、m4a；文本脚本会直接走百度文本驱动。',
      outputSettings: '输出设置',
      ...
      ttsSettings: 'TTS 参数',
      ttsPerson: '发音人 ID',
      ttsPersonPlaceholder: '留空使用百度默认音色',
      ttsLan: '语言',
      ttsSpeed: '语速',
      ttsVolume: '音量',
      ttsPitch: '语调',
      ...
      voiceDrive: '语音驱动',
      voiceDriveHint: '语音文件会作为 inputAudioUrl 提交给百度，TTS 参数只在文本驱动时生效。',
      generate: '生成视频',
      submitting: '提交中...',
      library: '视频管理',
  ...
  'en-US': {
    ...
    offlineVideo: {
      ...
      baiduAudioHint: 'Baidu Xiling audio drive supports wav, mp3, wma, and m4a. Text scripts use Baidu TEXT drive directly.',
      ...
      backgroundImageUrlPlaceholder: 'https://example.com/background.png',
      ttsSettings: 'TTS Params',
      ttsPerson: 'Voice person ID',
      ttsPersonPlaceholder: 'Leave blank for Baidu default voice',
      ttsLan: 'Language',
      ttsSpeed: 'Speed',
      ttsVolume: 'Volume',
      ttsPitch: 'Pitch',
      autoAnimoji: 'Auto animoji',
      voiceDrive: 'Voice drive',
      voiceDriveHint: 'The voice file is submitted as inputAudioUrl. TTS params only apply to TEXT drive.',
